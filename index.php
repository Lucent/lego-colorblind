...
<input type="radio" name="type" value="Deuteranomaly" id="Deuteranomaly" <?= ($_GET["type"] == "Deuteranomaly" ? "checked" : "") ?>><label for="Deuteranomaly">Red-Green</label>
<input type="radio" name="type" value="Families" id="Families" <?= ($_GET["type"] == "Families" ? "checked" : "") ?>><label for="Families">Manuals</label>
